...
srun singularity run $SIF bash -c 'source /scratch/project_462000131/marlonto/LUMI-AI-Guide/resources/ai-guide-env-ml-flow/bin/activate && python -m torch.distributed.run --standalone --nnodes=1 --nproc_per_node=8 wandb_ddp_visiontransformer.py'